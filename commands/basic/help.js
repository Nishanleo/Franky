...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const BOT_ICON = "https://cdn.discordapp.com/attachments/1316875822602387509/1372139501962657853/IMG-20250317-WA0060.jpg?ex=6825affe&is=68245e7e&hm=316b6ea164727d69f35a6fdf359ed5089e06254973b7b0cd13843fc94a5c4329&";
            const EMBED_COLOR = "#5865F2"; 
            const FOOTER_TEXT = "K L U Bot | The Discord Operating System • Created by frankyhere";
            ...
            const createPages = (commandSet, type) => {
                ...
                pages.push({
                    ...
                    author: { name: 'K L U BOT • COMMAND CENTER' },
                    icon: '📚'
                });
            ...
            const createEmbed = () => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setAuthor({
                        ...
                        iconURL: BOT_ICON,
                        url: "https://discord.gg/ApSfEdprfM"
                    })
                    .setImage(helpBanner)
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ text: 'K L U Bot • Error' })
                .setTimestamp();
